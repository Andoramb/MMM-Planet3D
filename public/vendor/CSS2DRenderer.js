// Vendored from three.js r185 (examples/jsm/renderers/CSS2DRenderer.js),
// unmodified except for this import line - rewritten to a relative path so it
// shares the exact same Three.js instance as CloudsLayer.mjs, OrbitControls.js,
// and three-globe.mjs, all pointing at public/vendor/three.module.min.js. Only
// CSS2DRenderer itself is actually used (see Earth3DRenderer.js) - three-globe's
// own vendored bundle already carries its own internal CSS2DObject for
// htmlElementsData, so this file's CSS2DObject export goes unused here.
import {
	Matrix4,
	Object3D,
	Vector2,
